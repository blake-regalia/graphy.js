...
## Contents
 ...
 - [Verbs](#verbs) -- the module export functions under each content namespace
   - [`.read`](#verb_read) -- for reading RDF from a string or stream
     - _event_ [`readable(...)`](#event_read-readable)
     - _event_ [`base(...)`](#event_read-base)
     - _event_ [`prefix(...)`](#event_read-prefix)
     - _event_ [`comment(...)`](#event_read-comment)
     - _event_ [`data(...)`](#event_read-data)
     - _event_ [`enter(...)`](#event_read-enter)
     - _event_ [`exit(...)`](#event_read-exit)
     - _event_ [`progress(...)`](#event_read-progress)
     - _event_ [`eof(...)`](#event_read-eof)
     - _event_ [`end(...)`](#event_read-end)
     - _event_ [`error(...)`](#event_read-error)

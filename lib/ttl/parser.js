...
class StreamParser {
	...
	@{method('object_list')}
		...
		@{match('R_IRIREF', 'm_iriref_object')}
			...
			this.object = {@{KEY_IRI}: this.base + m_iriref_object[1], @{is_iri()}};
		...
		@{else_match('R_PREFIXED_NAME', 'm_prefixed_named_object')}
			...
			this.object = {@{KEY_IRI}: this.prefixes[m_prefixed_named_object[1]] + m_prefixed_named_object[2], @{is_iri()}};
		...
		@{else_match('R_NUMERIC_LITERAL', 'm_numeric_literal')}
			// commit literal
			this.object = {@{KEY_LITERAL_VALUE}: parseFloat(m_numeric_literal[1]), @{is_literal()}};

		// boolean literal
		@{else_match('R_BOOLEAN_LITERAL', 'm_boolean_literal')}
			// make literal
			this.object = {@{KEY_LITERAL_VALUE}: m_boolean_literal[1]? true: false, @{is_literal()}};
		...
		@{else_if_char('[')}
			...
			@{whitespace('i+1')}
				...
				@if NETWORK
					...
					this.pairs = {
						@{KEY_BLANK_NODE_LABEL}: '',
					};

					// push blanknode to object list
					this.objects.push(this.pairs);
				@else
					this.object = {@{KEY_BLANK_NODE_LABEL}: '', @{is_blank_node()}};
				@end
	...
	@{method('string_literal')}
		...
		let h_literal = this.object = {@{is_literal()}};

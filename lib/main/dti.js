...
class Serializer {
	constructor(ds_output, h_config, fk_writer) {
		...
		a_flow.push(...[
			...
			() => this.write_array(0x04, 0x03, 'len_l'),
		]);

		// uses SPO
		if(k_graph.data_sp) {
			a_flow.push(...[
				() => this.write_array(0x05, 0x00, 'data_sp'),
				() => this.write_array(0x05, 0x01, 'data_s_po'),
				() => this.write_array(0x06, 0x00, 'idx_sp'),
		...
		if(k_graph.data_po) {
			a_flow.push(...[
				() => this.write_array(0x05, 0x02, 'data_po'),
				() => this.write_array(0x05, 0x03, 'data_p_os'),
				() => this.write_array(0x06, 0x01, 'idx_po'),
		...
		if(k_graph.data_os) {
			a_flow.push(...[
				() => this.write_array(0x05, 0x04, 'data_os'),
				() => this.write_array(0x05, 0x05, 'data_o_sp'),
				() => this.write_array(0x06, 0x02, 'idx_os'),

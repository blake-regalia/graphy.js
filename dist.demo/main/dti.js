...
const A_SORTERS = [
	...
	'ref',
	(k, w) => {
		k.section_d = section.front_coded_null_vbyte_section(k.dict, k.ref, k.count, w, 1);
	...
	'ref',
	(k, w) => {
		k.section_s = section.front_coded_null_vbyte_section(k.dict, k.ref, k.count, w, 1 + k.section_d.count);
		k.term_count += k.count;
		delete k.count;
		delete k.dict;
		delete k.ref;
	...
	'ref',
	(k, w) => {
		k.section_o = section.front_coded_null_vbyte_section(k.dict, k.ref, k.count, w, 1 + k.section_d.count);
		k.term_count += k.count;
		delete k.count;
		delete k.dict;
		delete k.ref;
	...
	'ref',
	(k, w) => {
		k.section_l = section.front_coded_null_vbyte_section(k.dict, k.ref, k.count, w, 1 + k.section_d.count + k.section_o.count);
		k.term_count += k.count;
		delete k.count;
		delete k.dict;
		delete k.ref;
	...
	'ref',
	(k, w) => {
		k.section_p = section.front_coded_null_vbyte_section(k.dict, k.ref, k.count, w, 1);
		k.term_count += k.count;
		delete k.count;
		delete k.dict;
		delete k.ref;
	...
	(k, w) => {
		...
		k.triples_spo = triples.contiguous_adjacency_list_triples(k, s_a, s_b, s_c, k.idx_a_b, k.adj_a_b, k.idx_ab_c, at_adj_ab_c);
		delete k.term_codes;
		delete k.idx_a_b;
		delete k.adj_a_b;
		delete k.idx_ab_c;
